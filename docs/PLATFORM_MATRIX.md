...
| Live relay evidence | Manually accepted live | Pack45 driver identity confirmed on a physical Windows 11 host; awaiting v0.1.4 relay retest | Ubuntu 24.04 / WirePlumber 0.4 and Fedora 42 / PipeWire 1.4.11 / WirePlumber 0.5.14 accepted live |
...
The `v0.1.6` tag workflow builds target-native DMG/ZIP, NSIS, and AppImage artifacts and signs a
